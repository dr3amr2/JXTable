...
/**
 * This com.test.swingx.demo.SimpleJXTableDemo is a very simple example of how to use the extended features of the
 ...
 * java org.jdesktop.demo.sample.com.test.swingx.demo.SimpleJXTableDemo
 *
...
public class SimpleJXTableDemo {
    ...
    private JComponent initUI() {
        ...
        // TODO: not ready yet
        content.add(initSearchPanel(jxTable), BorderLayout.NORTH);
        content.add(initConfigPanel(jxTable), BorderLayout.SOUTH);
        return content;
    }
        ...
        filter.setAction(new AbstractAction("Show") {
            public void actionPerformed(ActionEvent e) {
                ...
                if (searchString.length() > 0) {
                    RowFilter<TableModel,Integer> temp = RowFilters.regexFilter(0, searchString);
                    jxTable.setRowFilter(temp);
                } else {
