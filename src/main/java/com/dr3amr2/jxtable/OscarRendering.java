...
//*
//*/
//package com.chesapeaketechnology.ibs.raptorx.plugins.ui.panels;
//
...
//            // TODO: Determine if getName is a unique case for all filters
...
//        FilterDataBean prototype = new FilterDataBean("Special Effects and");
...
//                new HyperlinkProvider(new FilterDataBeanLinkAction(), FilterDataBean.class));
//
//        // Visual Decorators
//        // .... and more
////        </snip>
...
////                if (value instanceof FilterDataBean) {
////                    return getURIText((FilterDataBean) value);
////                }
////                return "";
////            }
////            private String getURIText(FilterDataBean target) {
...
//     * <ul>
//     * <li>initially, the FilterDataBean only has properties movieTitle and year
//     * (of nomination)
...
//     * </ul>
//     */
//    public static class FilterDataBeanLinkAction extends
//            AbstractHyperlinkAction<FilterDataBean> {
//
